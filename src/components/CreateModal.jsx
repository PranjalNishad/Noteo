  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative z-50 w-full max-w-lg rounded-xl p-4 sm:p-6 glass overflow-auto max-h-[90vh]"
      >
        <h2 className="text-lg sm:text-xl font-semibold" style={{ color: "var(--accent)" }}>
          Create New Note
        </h2>
        ...
        <div className="mt-3 space-y-3 relative">
          ...
          <div className="flex gap-2 items-center">
            ...
            <label className="flex items-center gap-2 text-sm cursor-pointer select-none">
              <input
                ...
                onChange={(e) => setNewNote((s) => ({ ...s, pinned: e.target.checked }))}
          ...
          <input
            ...
            className="w-full px-3 py-2 rounded-md input-glass border border-white/6 text-sm sm:text-base"
            aria-label="Tags"
          />
          ...
          <div>
            ...
            <div className="rounded-md cursor-pointer border border-white/10 bg-white/5 p-2">
              <input
                ...
                className="w-full cursor-pointer rounded-md text-sm file:mr-4 file:rounded-md file:border-0 file:bg-[var(--accent)] file:px-3 file:py-1.5 file:text-sm file:font-medium file:text-black hover:file:bg-[var(--accent-2)] transition"
          ...
          <div className="flex justify-end gap-3 pt-2">
            <button
              ...
              className="px-3 py-2 rounded-md border border-white/20 cursor-pointer text-sm sm:text-base"
            >
              Cancel
            </button>
            <button
              onClick={handleCreateNote}
              className="px-4 py-2 rounded-md font-semibold btn-accent cursor-pointer text-sm sm:text-base"
            >
              Create
            </button>
          </div>
